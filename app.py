le cle est ne marche plus encore sur render quand il expose sur python anywhere et comment ne l expose pas sur pythonanywhere from flask import Flask, request, redirect, session, render_template_string, jsonify, send_file
import sqlite3
...
# Nouvelle clé API Gemini
GEMINI_API_KEY = 'AIzaSyDyllFAPi-uSGhkO2Q9VEgqTTOKkMmE00w'
...
# =====================================================
# ROUTE API POUR LE CHATBOT GEMINI - VERSION PYTHONANYWHERE
# =====================================================
@app.route('/api/chat', methods=['POST'])
def chat_with_gemini():
    """Route backend pour communiquer avec Gemini - Version PythonAnywhere"""
    try:
        ...
        # Modèles qui fonctionnent sur PythonAnywhere (gemini-1.0-pro et gemini-pro)
        models_to_try = [
            "gemini-1.0-pro",
            "gemini-pro"
        ]
...
Réponse:"""
                ...
                # verify=False pour PythonAnywhere (problèmes SSL)
